...
// query for getting user data from database
 ...
 if (isset($_SESSION['username'])) {
     ...
     if (!$select_user_info_query) {
         die("QUERY FAILED" . mysqli_error($connection));
     }
     while($row = mysqli_fetch_assoc($select_user_info_query)){
         $user_id = $row['user_id'];
 ...
 <?php 
  if (isset($_POST['submit'])) {
        ...
        $query = "UPDATE users SET user_firstname = '$user_firstname', user_lastname = '$user_lastname', username = '$username', user_role = '$user_role', user_image = '$user_image', user_password = '$user_password', user_email = '$user_email' WHERE username = '$username'";
